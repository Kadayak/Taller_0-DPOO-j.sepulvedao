...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un atleta por su nombre");
	...
	private void ejecutar_nombre_atleta() 
	{
		String nom = input("Digite el nombre del atleta a buscar: ");
		Atleta temp = calculadora.buscarAtleta(nom);
		System.out.println("El atleta " + temp.darNombre() + " representa al pais " + temp.darPais() + ".");
	}
